/**
 * Icons.jsx — Set único de iconos SVG (estilo Lucide, stroke 1.5)
 *
 * REGLA: No importar iconos de otras librerías. Añadir aquí si falta alguno.
 * Todos los iconos comparten: stroke="currentColor" strokeWidth="1.5"
 *                             strokeLinecap="round" strokeLinejoin="round"
 */

function Icon({ size = 18, color, className, style, children }) {
  return (
    <svg
      width={size}
      height={size}
...
export const HomeIcon      = (p) => <Icon {...p}><path d="M3 9L12 2l9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></Icon>;
export const BriefcaseIcon = (p) => <Icon {...p}><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></Icon>;
export const ClipboardIcon = (p) => <Icon {...p}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></Icon>;
export const BuildingIcon  = (p) => <Icon {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18M15 3v18M3 9h18M3 15h18"/></Icon>;
...
export const CompassIcon   = (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></Icon>;
...
export const FilterIcon    = (p) => <Icon {...p}><line x1="4" y1="6" x2="20" y2="6"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="11" y1="18" x2="13" y2="18"/></Icon>;
...
export const PinIcon       = (p) => <Icon {...p}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></Icon>;
export const MonitorIcon   = (p) => <Icon {...p}><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></Icon>;
...
export const FileTextIcon  = (p) => <Icon {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></Icon>;
export const PlusIcon      = (p) => <Icon {...p}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></Icon>;
export const TrashIcon     = (p) => <Icon {...p}><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></Icon>;
...
export const SpellcheckIcon = (p) => <Icon {...p}><path d="M6 19v-3"/><path d="M10 19v-7"/><path d="M14 19v-4"/><path d="M18 19v-9"/><path d="M3 13h16"/><path d="M3 7h3m0 0h3M6 7V4"/><path d="M12 7h3m0 0h3m-3 0V4"/></Icon>;
...
export const TrophyIcon    = (p) => <Icon {...p}><polyline points="14.5 17 12 22 9.5 17"/><path d="M6.17 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-2.17"/><path d="M4 5h16v6a8 8 0 0 1-16 0V5z"/></Icon>;